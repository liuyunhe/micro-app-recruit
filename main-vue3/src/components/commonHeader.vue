...
<template>
  <div class="common-header">
     ...
     <el-menu-item index="about">关于我们</el-menu-item>
      <el-button round plain size="small" v-if="globalData && globalData.token" class="login-btn" @click="logout">退出</el-button>
      <el-button round plain size="small" v-else class="login-btn" @click="()=>router.push({name:'login'})">登录</el-button>
     </el-menu>
  </div>
</template>
