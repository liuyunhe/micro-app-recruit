...
import { jobType } from '../../assets/js/dictData.js'

const jobTypeArr = ref(jobType)
console.log(jobTypeArr.value)

const placeholder = ref('请输入要搜索的关键字，如：会计、仓管、设计师等')
const homeSelectValue = ref('1')
const homeSearchValue = ref('')
const homeData = ref({
  hotKeyList: ['前端开发', 'Java工程师', '产品经理', 'UI设计师', '销售专员'],
  indexBannelList: [
    {
      bannelUrlWeb: 'https://picsum.photos/950/485?random=1',
      linkUrl: '/jobs'
    },
    {
      bannelUrlWeb: 'https://picsum.photos/950/485?random=2',
      linkUrl: '/enterprise'
    }
  ],
  newJobList: [
    {
      ...
      workCity: '北京',
      workExperience: 5,
      enterpriseLogo: 'https://picsum.photos/45/45?random=3',
      enterpriseName: '阿里云科技',
      scale: '500',
      industry: '互联网'
    }
    // 更多职位数据...
  ...
  famousEnterpriseList: [
    {
      ...
      industry: '金融科技',
      recruitJobCount: 23,
      jobs: [{ jobTitle: 'Java开发工程师' }, { jobTitle: '数据安全专家' }]
    }
    // 更多企业数据...
  ]
})
...
const toJobList = () => {
  ...
  if (window.__MICRO_APP_ENVIRONMENT__) {
    ...
    baseRouter.push('/main/childEnterprise#/enterpriseDetail?enterpriseId=undefined')
  }
}
const toJobDetail = () => {}
const toEnterpriseDetail = () => {}
const toEnterpriseList = () => {}
// const asyncData = ({ store, params }) => {
